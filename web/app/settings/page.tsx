      ...
      <div className="page">
        <div className="fade" style={{ maxWidth: 580 }}>
          ...
          <p className="muted" style={{ margin: "6px 0 24px" }}>
            POC 阶段：创意步直接调用<b>本机 claude 命令行</b>，复用你已登录的
            Claude Code，<b>零 API key</b>。
          </p>
          <div className="card pad">
            ...
            >
              claude -p &quot;…&quot; --output-format json --model &lt;档&gt;
              --append-system-prompt &quot;&lt;四件套知识包&gt;&quot;
            </div>
            ...
            <div className="hint" style={{ marginTop: 12 }}>
              v1 生产将增加 <b>BYO Anthropic key</b>
              （粘贴到设置 · 仅存浏览器 · 请求透传 · 不落盘）。POC
              先用本机 CLI 跑通。
            </div>
